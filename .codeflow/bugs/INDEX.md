...
|---|---------|--------|------------|------|--------|--------|
| 001 | [001-fluxo-cadastro-refeicao.md](001-fluxo-cadastro-refeicao.md) | Cadastro de refeição não-determinístico e impreciso; banco nutricional subutilizado | alto | backend/ai | aberto | 2026-07-09 |
