...
from app.models.meal import Meal, MealSource, MealType
...
LUNCH_OPTIONS = [
    ...
    },
    {
        ...
        "items": [
            ...
            {
                "food_name": "Carne bovina magra grelhada",
                "quantity": 120,
                "unit": "g",
                "calories": 228,
                "protein": 27,
    ...
    },
    {
        ...
        "items": [
            {
                "food_name": "Macarrão integral cozido",
                "quantity": 200,
                "unit": "g",
                "calories": 284,
                "protein": 10,
    ...
    async with AsyncSessionLocal() as session:
        ...
        for days_ago in range(30, 0, -1):
            ...
            for t in random.sample(horarios, n_copos):
                ...
                session.add(
                    HydrationLog(user_id=USER_ID, amount_ml=amount, date=day, time=t)
                )
        ...
        print("  → 30 dias de refeições (~4-6 por dia)")
        print("  → 10 registros de peso")
        print("  → 30 dias de hidratação")
        print("  → 30 dias de humor/energia")
        print("  → 4 lembretes configurados")
