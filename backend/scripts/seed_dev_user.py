...
BREAKFASTS = [
    ...
    },
    {
        ...
        "items": [
            ...
            {
                "food_name": "Queijo minas frescal",
                "quantity": 50,
                "unit": "g",
                "calories": 74,
                "protein": 7.0,
            ...
            {
                "food_name": "Suco de laranja natural",
                "quantity": 200,
                "unit": "ml",
                "calories": 88,
                "protein": 1.4,
...
LUNCHES = [
    ...
    },
    {
        ...
        "items": [
            {
                "food_name": "Bife de acém grelhado",
                "quantity": 180,
                "unit": "g",
                "calories": 306,
                "protein": 38.0,
    ...
    },
    {
        ...
        "items": [
            {
                "food_name": "Peito de frango assado",
                "quantity": 200,
                "unit": "g",
                "calories": 274,
                "protein": 51.0,
    ...
    },
    {
        ...
        "items": [
            {
                "food_name": "Macarrão penne cozido",
                "quantity": 200,
                "unit": "g",
                "calories": 286,
                "protein": 9.6,
            ...
            {
                "food_name": "Carne moída refogada",
                "quantity": 120,
                "unit": "g",
                "calories": 258,
                "protein": 25.0,
            ...
            {
                "food_name": "Queijo parmesão ralado",
                "quantity": 15,
                "unit": "g",
                "calories": 70,
                "protein": 6.2,
    ...
    },
    {
        ...
        "items": [
            ...
            {
                "food_name": "Salada de tomate e pepino",
                "quantity": 120,
                "unit": "g",
                "calories": 22,
                "protein": 1.0,
    ...
    },
    {
        ...
        "items": [
            ...
            {
                "food_name": "Molho de iogurte light",
                "quantity": 30,
                "unit": "g",
                "calories": 19,
                "protein": 1.8,
...
DINNERS = [
    {
        ...
        "items": [
            {
                "food_name": "Sopa de legumes com macarrão",
                "quantity": 400,
                "unit": "ml",
                "calories": 168,
                "protein": 6.4,
    ...
    },
    {
        ...
        "items": [
            {
                "food_name": "Panqueca de aveia e banana (2 un)",
                "quantity": 150,
                "unit": "g",
                "calories": 280,
                "protein": 12.0,
    ...
    },
    {
        ...
        "items": [
            {
                "food_name": "Atum em água escorrido",
                "quantity": 120,
                "unit": "g",
                "calories": 121,
                "protein": 27.0,
            ...
            {
                "food_name": "Azeite e limão (molho)",
                "quantity": 15,
                "unit": "ml",
                "calories": 120,
                "protein": 0.0,
...
SNACKS = [
    ...
    },
    {
        ...
        "items": [
            {
                "food_name": "Biscoito de água e sal integral",
                "quantity": 30,
                "unit": "g",
                "calories": 115,
                "protein": 2.5,
...
def clear_existing_data(session: Session, user_id: int) -> None:
    ...
    session.execute(
        text("DELETE FROM weight_logs WHERE user_id = :uid"), {"uid": user_id}
    )
    session.execute(
        text("DELETE FROM hydration_logs WHERE user_id = :uid"), {"uid": user_id}
    )
    session.execute(
        text("DELETE FROM mood_logs WHERE user_id = :uid"), {"uid": user_id}
    )
    session.commit()
...
def update_user_profile(session: Session, user_id: int) -> None:
    ...
    session.execute(
        text(
            "UPDATE users SET calorie_goal = 2000, weight_goal = 78.0 WHERE id = :uid"
        ),
        {"uid": user_id},
    )
...
def seed_meals(
    session: Session, user_id: int, target_date: date, rng: random.Random
) -> None:
...
def seed_weight(
    session: Session, user_id: int, target_date: date, weight: float
) -> None:
    """Insere log de peso."""
    session.execute(
        text("""
